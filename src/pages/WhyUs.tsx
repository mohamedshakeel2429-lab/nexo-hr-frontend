    ...
    <div className="pt-24 md:pt-32 pb-20">
      ...
      <section className="section-padding">
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          <div className="glass p-6 md:p-12 rounded-[2rem] md:rounded-[3.5rem] bg-slate-900/50 border-red-500/10">
            <div className="flex items-center gap-3 mb-6 md:mb-8 text-red-500">
              <MinusSquare size={24} className="md:hidden" />
              <MinusSquare size={32} className="hidden md:block" />
              <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight">Traditional HR</h3>
            </div>
            <ul className="space-y-4 md:space-y-6">
              {[
                ...
                <li key={i} className="flex gap-3 md:gap-4 text-slate-500 text-sm italic">
          ...
          <div className="glass p-6 md:p-12 rounded-[2rem] md:rounded-[3.5rem] bg-gradient-to-br from-brand-accent/20 via-brand-blue to-blue-500/5 border-brand-accent/30 ring-1 ring-brand-accent/20 shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-brand-accent/20 blur-3xl" />
            <div className="flex items-center gap-3 mb-6 md:mb-8 text-brand-accent">
              <ShieldCheck size={24} className="md:hidden" />
              <ShieldCheck size={32} className="hidden md:block" />
              <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight">The NEXO Way</h3>
            </div>
            <ul className="space-y-4 md:space-y-6">
              {[
                ...
                <li key={i} className="flex gap-3 md:gap-4 text-slate-200 font-bold group">
      ...
      <section className="section-padding bg-slate-950/40 border-y border-white/5">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12 text-center">
          {[
            ...
            <div key={i} className="space-y-2 md:space-y-3 group">
              <div className="w-10 h-10 md:w-12 md:h-12 glass rounded-xl md:rounded-2xl flex items-center justify-center text-brand-accent mx-auto mb-3 md:mb-4 group-hover:scale-110 transition-transform">
                <stat.icon size={20} />
              </div>
              <p className="text-3xl md:text-5xl font-black text-white">{stat.val}</p>
              <p className="text-[9px] md:text-[10px] font-black text-slate-500 uppercase tracking-widest leading-relaxed px-2 md:px-10">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
          <div className="lg:col-span-2 glass rounded-[2rem] md:rounded-[3rem] overflow-hidden group">
            <div className="grid md:grid-cols-2 h-full">
              <div className="p-6 md:p-12 space-y-4 md:space-y-6 flex flex-col justify-center">
                <h3 className="text-xl md:text-3xl font-bold text-white uppercase tracking-tight">
                  Chennai's Local <br /> SME Experts
                </h3>
                ...
                <Link to="/contact" className="inline-flex items-center gap-2 text-brand-accent font-bold hover:gap-4 transition-all text-sm md:text-base">
                  Work with local experts <ArrowRight size={16} />
                </Link>
              </div>
          ...
          <div className="glass p-6 md:p-12 rounded-[2rem] md:rounded-[3.5rem] flex flex-col justify-center bg-gradient-to-t from-brand-primary/10 to-transparent">
            <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 uppercase tracking-tight">Cost vs. Value</h3>
      ...
      <section className="section-padding text-center">
        <h2 className="text-xl md:text-3xl font-bold text-white mb-6 uppercase tracking-tighter">Experience the transformation</h2>
        <Link to="/contact" className="btn-primary text-[14px] md:text-[16px] uppercase tracking-[0.2em]">
